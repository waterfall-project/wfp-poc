...
def upgrade():
    ...
    sa.Column('current_rae_date', sa.DateTime(), nullable=True),
    sa.Column('id', app.models.types.GUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    ...
    sa.Column('resource_id', app.models.types.GUID(), nullable=False),
    sa.Column('project_id', app.models.types.GUID(), nullable=False),
    sa.Column('ms_project_uid', sa.Integer(), nullable=True),
    sa.Column('percent_allocation', sa.Integer(), nullable=False),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.CheckConstraint('percent_allocation <= 100', name='ck_assignment_percent_allocation_max'),
    sa.CheckConstraint('percent_allocation >= 0', name='ck_assignment_percent_allocation_min'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    ...
    sa.Column('project_id', app.models.types.GUID(), nullable=False),
    sa.Column('milestone_id', app.models.types.GUID(), nullable=True),
    ...
    sa.Column('purchase_document', sa.String(length=50), nullable=True),
    sa.Column('fiscal_year', sa.Integer(), nullable=True),
    sa.Column('period', sa.Integer(), nullable=True),
    sa.Column('otp_element', sa.String(length=50), nullable=True),
    sa.Column('accounting_nature', sa.String(length=50), nullable=True),
    sa.Column('vendor_name', sa.String(length=255), nullable=True),
    sa.Column('origin_group', sa.String(length=50), nullable=True),
    sa.Column('id', app.models.types.GUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.CheckConstraint("category IN ('labor', 'procurement', 'subcontracting', 'overhead')", name='ck_expenses_category'),
    sa.CheckConstraint('amount >= 0', name='ck_expenses_amount_non_negative'),
    sa.CheckConstraint('period IS NULL OR (period >= 1 AND period <= 12)', name='ck_expenses_period_range'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'reference_number', 'date', 'amount', name='uq_expenses_project_reference_date_amount')
    )
    ...
    sa.Column('milestone_id', app.models.types.GUID(), nullable=False),
    sa.Column('date', sa.DateTime(), nullable=False),
    sa.Column('amount', sa.Numeric(precision=15, scale=2), nullable=False),
    sa.Column('updated_by', app.models.types.GUID(), nullable=False),
    sa.Column('comment', sa.String(length=500), nullable=True),
    sa.Column('details', app.models.types.JSONB(), nullable=True),
    sa.Column('id', app.models.types.GUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    ...
    sa.Column('predecessor_id', app.models.types.GUID(), nullable=False),
    sa.Column('successor_id', app.models.types.GUID(), nullable=False),
