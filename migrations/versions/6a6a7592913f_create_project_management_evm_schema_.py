"""Create Project Management & EVM schema with all entities
...
def upgrade():
    ...
    sa.Column('budget_at_completion', sa.Float(), nullable=True),
    sa.Column('status', sa.String(length=20), nullable=False),
    sa.Column('id', GUID(), nullable=False),
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.CheckConstraint("status IN ('active', 'completed', 'cancelled', 'on_hold')", name='ck_projects_status'),
    ...
    sa.Column('created_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.Column('updated_at', sa.DateTime(), server_default=sa.text('(CURRENT_TIMESTAMP)'), nullable=False),
    sa.CheckConstraint("status IN ('not_reached', 'reached', 'missed')", name='ck_milestones_status'),
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    ...
    with op.batch_alter_table('milestones', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_milestones_planned_date'), ['planned_date'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('milestones', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_milestones_planned_date'))
